...
sed -i -e "/READ_B2MOD_TRANSPORT_NAMELIST/a\  parm_dnad(1) = 1.0_R8" b2tqna_d.F90
sed -i -e "/READ_B2MOD_TRANSPORT_NAMELIST/a\  parm_dnad = 0.0_R8" b2tqna_d.F90
sed -i -e 's/parm_dnad(1) = 0.0/parm_dnad(1) = 1.0_R8/g' b2tqna_d.F90
