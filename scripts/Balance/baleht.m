...
areadownrad = radial_balance(...
 ...
 cat(3,raddive_32,raddive_52,raddive_cond,raddive_thermj,raddive_dia,raddive_ecrb,raddive_strange,raddive_pschused,b2stbc_she,...
       ...
       b2sihs_diae,b2sihs_divue,b2sihs_exbe,b2sihs_joule,b2npht_shei,b2stbr_phys_she,b2stbr_bas_she,b2stbr_first_flight_she)/1E6,...
 reshe/1E6,...
 {'dA_{xu}q_{exu}/dA_{||d}',...
  'dA_{xd}q_{exd}/dA_{||d}',...
 ...
 {'rad. diverg. fhey\_32','rad. diverg. fhey\_52','rad. diverg. fhey\_cond','rad. diverg. fhey\_thermj',...
  ...
  'b2sihs\_diae','b2sihs\_divue','b2sihs\_exbe','b2sihs\_joule','equipartition','b2stbr\_phys','b2stbr\_bas','b2stbr\_first\_flight'},...
