...
% Radial balance
raddiv_32 = raddiv(fhex_32,fhey_32,comuse,facesup,facesdown,areatype);
raddiv_52 = raddiv(fhex_52,fhey_52,comuse,facesup,facesdown,areatype);
raddiv_thermj = raddiv(fhex_thermj,fhey_thermj,comuse,facesup,facesdown,areatype);
raddiv_cond = raddiv(fhex_cond,fhey_cond,comuse,facesup,facesdown,areatype);
raddiv_dia = raddiv(fhex_dia,fhey_dia,comuse,facesup,facesdown,areatype);
raddiv_ecrb = raddiv(fhex_ecrb,fhey_ecrb,comuse,facesup,facesdown,areatype);
raddiv_strange = raddiv(fhex_strange,fhey_strange,comuse,facesup,facesdown,areatype);
raddiv_pschused = raddiv(fhex_pschused,fhey_pschused,comuse,facesup,facesdown,areatype);

% Poloidal balance
raddiv_32_pol = raddiv(fhex_32,fhey_32,comuse,[],[],areatype);
raddiv_52_pol = raddiv(fhex_52,fhey_52,comuse,[],[],areatype);
raddiv_thermj_pol = raddiv(fhex_thermj,fhey_thermj,comuse,[],[],areatype);
raddiv_cond_pol = raddiv(fhex_cond,fhey_cond,comuse,[],[],areatype);
raddiv_dia_pol = raddiv(fhex_dia,fhey_dia,comuse,[],[],areatype);
raddiv_ecrb_pol = raddiv(fhex_ecrb,fhey_ecrb,comuse,[],[],areatype);
raddiv_strange_pol = raddiv(fhex_strange,fhey_strange,comuse,[],[],areatype);
raddiv_pschused_pol = raddiv(fhex_pschused,fhey_pschused,comuse,[],[],areatype);

%% Make plots...
btp = radial_balance(...
 cat(2,fhe_32,fhe_52,fhe_cond,fhe_thermj,fhe_dia,fhe_ecrb,fhe_strange,fhe_pschused)/1E6,...
 cat(2,raddiv_32,raddiv_52,raddiv_cond,raddiv_thermj,raddiv_dia,raddiv_ecrb,raddiv_strange,raddiv_pschused,...
       b2stbc_she,...
...
areadownpol = poloidal_balance(...
 cat(2,fhe_32,fhe_52,fhe_cond,fhe_thermj,fhe_dia,fhe_ecrb,fhe_strange,fhe_pschused)/1E6,...
 cat(2,raddiv_32_pol,raddiv_52_pol,raddiv_cond_pol,raddiv_thermj_pol,raddiv_dia_pol,raddiv_ecrb_pol,raddiv_strange_pol,raddiv_pschused_pol,...
       b2stbc_she,...
       sum(eirene_mc_eael_she,2),sum(eirene_mc_emel_she,2),sum(eirene_mc_eiel_she,2),sum(eirene_mc_epel_she,2),...
       b2stbm_she,ext_she,...
       b2srsm_she,b2srdt_she,b2srst_she,...
