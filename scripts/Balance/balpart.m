...
% Fluxes:
tmp = ncread(balfile,'fna_pinch'); % FIX THIS!!
...
areadownrad = radial_balance(...
 ...
 cat(3,raddiv_drift,raddiv_pll,raddiv_nanom,raddiv_panom,raddiv_pinch,raddiv_ch,raddiv_pschused,...
       ...
       b2stel_sna_ion,b2stel_sna_rec,b2stbc_sna,b2stbm_sna,b2stcx_sna,ext_sna,b2srdt_sna,b2srsm_sna,b2srst_sna,b2stbr_phys_sna,b2stbr_bas_sna,b2stbr_first_flight_sna),...
 rescb,...
 {'dA_{xu}\Gamma_{xu}/dA_{||d}',...
  '\Gamma_{||d}',...
  '(\int_d^uS_{part}^{tot}dV)/dA_{||d}',...
  '(\int_d^ures.dV)/dA_{||d}'},...
 {'poloidal projection of nv_{||}','dia.+ExB drifts','anomalous density diffusion','anomalous pressure diffusion','anomalous pinch','fnbx\_ch','PS'},...
 {'rad. drift diverg.','rad. diverg. nv_{||}','rad. density diffusion diverg.','rad. pressure diffusion diverg.','rad. pinch diverg.','rad. diverg. fnby\_ch','rad. P-S diverg.',...
  ...
  'b2stel ion','b2stel rec','b2stbc','b2stbm','b2stcx','source\_input','b2srdt','b2srsm','b2srst','b2stbr\_phys','b2stbr\_bas','b2stbr\_first\_flight'},...
