...
raddiv_drift = raddiv(fnbx_drift,fnby_drift,comuse,indrad,facesup,facesdown,areatype);
raddiv_nanom = raddiv(fnbx_nanom,fnby_nanom,comuse,indrad,facesup,facesdown,areatype);
raddiv_panom = raddiv(fnbx_panom,fnby_panom,comuse,indrad,facesup,facesdown,areatype);
