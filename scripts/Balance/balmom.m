...
areadownrad = radial_balance(...
 ...
 cat(3,visc,raddiv_flua,raddiv_vis,b2stbc_smo,sum(eirene_mc_mapl_smo,4),...
       ...
       b2siav_smovh,b2siav_smovv,b2sicf_smo,b2nxdv_smo,b2sigp_smogp,b2stbr_not_eirene),...      
 resmo,...
 ...
 {'parallel viscosity','rad. diverg. $nmu_\parallel u_y$','rad. diverg. visc.','b2stbc',...
  ...
  'b2stel\_rec','b2stcx','b2srsm','b2srdt','b2srst','b2sifr','b2siav\_smovh','b2siav\_smovv','b2sicf','b2nxdv\_smo','stat. press. gradient','b2stbr not Eirene'},...
