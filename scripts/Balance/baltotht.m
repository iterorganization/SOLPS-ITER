...
raddivi_vzh = raddiv(fhix_vzh,fhiy_vzh,comuse,facesup,facesdown,areatype);
...
raddivi_vzh_pol = raddiv(fhix_vzh,fhiy_vzh,comuse,[],[],areatype);

%% Make plots...
bth = radial_balance(...
 cat(2,fhe_32,fhi_32,fhe_52,fhi_52,fhe_cond,fhi_cond,fhe_thermj,fhe_dia,fhi_dia,fhe_ecrb,fhi_ecrb,fhe_strange,...
       fhi_strange,fhe_pschused,fhi_pschused,fhi_inert,fhi_vispar,fhi_anml,fhi_kevis,fhi_vzh)/1E6,...
 cat(2,raddive_32,raddivi_32,raddive_52,raddivi_52,raddive_cond,raddivi_cond,raddive_thermj,raddive_dia,...
       raddivi_dia,raddive_ecrb,raddivi_ecrb,raddive_strange,raddivi_strange,raddive_pschused,raddivi_pschused,...
       raddivi_inert,raddivi_vispar,raddivi_anml,raddivi_kevis,raddivi_vzh,b2stbc_she,b2stbc_shi,...
 ...
 {'fhe\_32','fhi\_32','fhe\_52','fhi\_52','fhe\_cond','fhi\_cond','fhe\_thermj','fhe\_dia','fhi\_dia','fhe\_ecrb','fhi\_ecrb','fhe\_strange',...
  'fhi\_strange','fhe\_pschused','fhi\_pschused','fhi\_inert','fhi\_vispar','fhi\_anml','fhi\_kevis','fhi\_vzh'},...
 [{'rad. diverg. fhe\_32','rad. diverg. fhi\_32','rad. diverg. fhe\_52','rad. diverg. fhi\_52','rad. diverg. fhe\_cond','rad. diverg. fhi\_cond',...
 'rad. diverg. fhe\_thermj','rad. diverg. fhe\_dia','rad. diverg. fhi\_dia','rad. diverg. fhe\_ecrb','rad. diverg. fhi\_ecrb','rad. diverg. fhe\_strange',...
  'rad. diverg. fhi\_strange','rad. diverg. fhe\_pschused','rad. diverg. fhi\_pschused','rad. diverg. fhi\_inert','rad. diverg. fhi\_vispar','rad. diverg. fhi\_anml','rad. diverg. fhi\_kevis','rad. diverg. fhi\_vzh',...
...
pb = poloidal_balance(...
 ...
 cat(2,raddive_32_pol,raddivi_32_pol,raddive_52_pol,raddivi_52_pol,raddive_cond_pol,raddivi_cond_pol,raddive_thermj_pol,...
       ...
       raddive_pschused_pol,raddivi_pschused_pol,raddivi_inert_pol,raddivi_vispar_pol,raddivi_anml_pol,raddivi_kevis_pol,raddivi_vzh_pol,b2stbc_she,b2stbc_shi,...
       sum(eirene_mc_eael_she,2),sum(eirene_mc_emel_she,2),sum(eirene_mc_eiel_she,2),sum(eirene_mc_epel_she,2),...
       sum(eirene_mc_eapl_shi,2),sum(eirene_mc_empl_shi,2),sum(eirene_mc_eipl_shi,2),sum(eirene_mc_eppl_shi,2),...
       b2stbm_she,b2stbm_shi,ext_she,ext_shi,...
       b2stel_shi_ion,b2stel_shi_rec,b2stcx_shi,b2srsm_she,b2srsm_shi,b2srdt_she,b2srdt_shi,b2srst_she,b2srst_shi,...
 ...
 'rad. diverg. fhi\_ecrb','rad. diverg. fhe\_strange','rad. diverg. fhi\_strange','rad. diverg. fhe\_pschused',...
 'rad. diverg. fhi\_pschused','rad. diverg. fhi\_inert','rad. diverg. fhi\_vispar','rad. diverg. fhi\_anml','rad. diverg. fhi\_kevis','rad. diverg. fhi\_vzh',...
  'b2stbc\_she','b2stbc\_shi',...
  'eirene\_mc atm.-plasma el.','eirene\_mc mol.-plasma el.','eirene\_mc t.ion-plasma el.','eirene\_mc recomb. el.',...
  'eirene\_mc atm.-plasma ion','eirene\_mc mol.-plasma ion','eirene\_mc t.ion-plasma ion','eirene\_mc recomb. ion',...
  'b2stbm\_she','b2stbm\_shi','ext\_she','ext\_shi',...
