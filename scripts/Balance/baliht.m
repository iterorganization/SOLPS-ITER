...
raddiv_32 = raddiv(fhix_32,fhiy_32,comuse,indrad,facesup,facesdown,areatype);
raddiv_52 = raddiv(fhix_52,fhiy_52,comuse,indrad,facesup,facesdown,areatype);
raddiv_cond = raddiv(fhix_cond,fhiy_cond,comuse,indrad,facesup,facesdown,areatype);
raddiv_dia = raddiv(fhix_dia,fhiy_dia,comuse,indrad,facesup,facesdown,areatype);
raddiv_ecrb = raddiv(fhix_ecrb,fhiy_ecrb,comuse,indrad,facesup,facesdown,areatype);
raddiv_strange = raddiv(fhix_strange,fhiy_strange,comuse,indrad,facesup,facesdown,areatype);
raddiv_pschused = raddiv(fhix_pschused,fhiy_pschused,comuse,indrad,facesup,facesdown,areatype);
raddiv_inert = raddiv(fhix_inert,fhiy_inert,comuse,indrad,facesup,facesdown,areatype);
raddiv_vispar = raddiv(fhix_vispar,fhiy_vispar,comuse,indrad,facesup,facesdown,areatype);
raddiv_anml = raddiv(fhix_anml,fhiy_anml,comuse,indrad,facesup,facesdown,areatype);
raddiv_kevis = raddiv(fhix_kevis,fhiy_kevis,comuse,indrad,facesup,facesdown,areatype);
...
btp = radial_balance(...
 ...
 cat(2,raddiv_32,raddiv_52,raddiv_cond,raddiv_dia,raddiv_ecrb,raddiv_strange,raddiv_pschused,...
       raddiv_inert,raddiv_vispar,raddiv_anml,raddiv_kevis)/1E6,...
 reshi/1E6,...
 {'total upstream flux',...
...
areadownpol = poloidal_balance(...
 cat(2,fhi_32,fhi_52,fhi_cond,fhi_dia,fhi_ecrb,fhi_strange,fhi_pschused,...
       fhi_inert,fhi_vispar,fhi_anml,fhi_kevis)/1E6,...
 cat(2,fhi2_32,fhi2_52,fhi2_cond,fhi2_dia,fhi2_ecrb,fhi2_strange,fhi2_pschused,...
       fhi2_inert,fhi2_vispar,fhi2_anml,fhi2_kevis)/1E6,...
 cat(2,b2stbc_shi,...
       sum(eirene_mc_eapl_shi,2),sum(eirene_mc_empl_shi,2),sum(eirene_mc_eipl_shi,2),sum(eirene_mc_eppl_shi,2),...
       b2stbm_shi,ext_shi,...
       b2stel_shi_ion,b2stel_shi_rec,b2stcx_shi,b2srsm_shi,b2srdt_shi,b2srst_shi,...
