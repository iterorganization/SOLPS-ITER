...
fhix_vispar = tmp(:,:,1);
fhiy_vispar = tmp(:,:,2);
tmp = ncread(balfile,'fhi_visper');
fhix_visper = tmp(:,:,1);
fhiy_visper = tmp(:,:,2);
tmp = ncread(balfile,'fhi_visq');
fhix_visq = tmp(:,:,1);
fhiy_visq = tmp(:,:,2);
...
raddivi_visper = zeros(nx,ny);
raddivi_visq = zeros(nx,ny);
...
for iy=1:ny
    for ix=1:nx
        ...
        raddivi_visper(ix,iy) = fhiy_visper(ix,iy)-fhiy_visper(topix(ix,iy),topiy(ix,iy));
        raddivi_visq(ix,iy) = fhiy_visq(ix,iy)-fhiy_visq(topix(ix,iy),topiy(ix,iy));
...
areadownrad = radial_balance(...
 cat(3,fhix_32,fhix_52,fhix_cond,fhix_dia,fhix_ecrb,fhix_strange,fhix_pschused,...
       fhix_inert,fhix_vispar,fhix_visper,fhix_visq,fhix_anml,fhix_kevis)/1E6,...
 cat(3,raddivi_32,raddivi_52,raddivi_cond,raddivi_dia,raddivi_ecrb,raddivi_strange,raddivi_pschused,...
       raddivi_inert,raddivi_vispar,raddivi_visper,raddivi_visq,raddivi_anml,raddivi_kevis,b2stbc_shi,...
 ...
 {'fhix\_32','fhix\_52','fhix\_cond','fhix\_dia','fhix\_ecrb','fhix\_strange','fhix\_pschused',...
  'fhix\_inert','fhix\_vispar','fhix\_visper','fhix\_visq','fhix\_anml','fhix\_kevis'},...
 {'rad. diverg. fhiy\_32','rad. diverg. fhiy\_52','rad. diverg. fhiy\_cond','rad. diverg. fhiy\_dia',...
  ...
  'rad. diverg. fhiy\_inert','rad. diverg. fhiy\_vispar','rad. diverg. fhiy\_visper','rad. diverg. fhiy\_visq','rad. diverg. fhiy\_anml','rad. diverg. fhiy\_kevis','b2stbc\_shi',...
