...
mv b2mod_chord_shift_dv.F90 b2mod_chord_shift_diffv.F90
...
sed -i -e 's/use b2us_map/use b2us_map_diffv_diffv/g' b2mod_cdf.F90 b2mod_astra_to_b2.F b2mod_b2_to_astra.F b2mod_blnc.F b2mod_blnm.F b2mod_geometry.F90 b2mod_mwti.F90 b2mod_trace.F b2uxus.F tallies.F  b2mod_wrsrt.F b2mod_blne.F b2mod_wrint.F b2mod_wrsep.F
...
sed -i -e 's/use b2us_geo/use b2us_geo_diffv_diffv/g' b2mod_blnc.F b2mod_geometry.F90 b2mod_mwti.F90 b2mod_trace.F cdfmovie.F tallies.F b2mod_wrsrt.F b2mod_blne.F b2mod_blnm.F b2mod_wrint.F b2mod_wrsep.F
sed -i -e 's/use b2us_plasma/use b2us_plasma_diffv_diffv/g' b2mod_blnc.F b2mod_blnm.F b2mod_mwti.F90 b2mod_trace.F calc_err.F cdfmovie.F tallies.F b2mod_file.F b2mod_wrsrt.F b2mod_blne.F b2mod_wrint.F b2mod_wrsep.F b2mwmv.F
sed -i -e 's/use b2us_work/use b2us_work_diffv_diffv/g' b2mwmv.F
...
sed -i -e 's/use b2mod_math/use b2mod_math_diffv_diffv/g' b2mod_geo2.F b2mod_interp.F90 damax.F ifill.F ma28copy.F sfill.F smax.F smin.F calc_err.F
...
sed -i -e '/INTRINSIC MAX/d' b2wdat_dv.F90 b2tqna_dv_dv.F90 b2news__dv_dv.F90 b2news_m_dv_dv.F90 b2stel_dv_dv.F90 b2tqna_dv_dv.F90 set_parameters_dv.F90
...
sed -i -e "0,/!\*      ..compute norms of the differentiated corrections/s/!\*      ..compute norms of the differentiated corrections/        CALL B2MXAR_DIFFV_DIFFV(ncv, ns, mpg%nnreg(0), switch%boris, switch\&\n\&                          , geo, mpg, stdd%pl, stdd%dv, stdd%diag)\n!\*      ..compute norms of the differentiated corrections/g" b2mndt_dv_dv.F90
...
sed -i 's/B2XPNE_ST_NODIFF/B2XPNE_ST/g' b2mod_running_average_diffv_diffv.F90 b2rups_dv_dv.F90
...
sed -i 's/cfwure/cfwure_nodiff/g' b2mod_residuals.F b2mwmv.F
sed -i 's/call intcell/call intcell_nodiff_nodiff/g' b2mod_mwti.F90
sed -i 's/b2scopy/b2scopy_nodiff_nodiff/g' b2mwmv.F
sed -i 's/b2saxpy/b2saxpy_nodiff_nodiff/g' b2mwmv.F
