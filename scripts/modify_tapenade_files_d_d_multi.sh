...
move_to_F90.sh
rm b2mod_astra_to_b2_dv.F90 b2mod_eirdiag_dv.F90 b2uxus_hess_tgt_dv.F90 my_outi_us_dv.F90 b2uxus_dv_dv.F90 eirflux_map_dv.F90 get_jsep_dv.F90 smax_dv.F90 smin_dv.F90 print_tgt_gradient_dv.F90 set_tgt_perturbation_dv.F90 dim_dv.F90
...
sed -i -e 's/use b2mod_external/use b2mod_external_diffv_diffv/g' b2mod_blne.F b2mod_mwti.F90 b2mod_usrtrc.F b2mod_usrtrc.F b2mod_wrint.F b2mod_wrsep.F b2mod_wrsrt.F
...
sed -i -e 's/nbdirsmax/nbdirsmax0/g' dim_dv.F90
sed -i -e 's/#NBDirsMax#/nbdirsmax0/g' b2uxus_dv_dv.F90 solve_covariance_dv_dv.F90 dim_dv.F90 damax_dv.F90
...
sed -i '/EXTERNAL MAXVAL_DV2/d' ./*.F90
...
sed -i -e "s/cfdna(0, is), cfdnad0(:, 0, is)/cfdna(0, is), cfdnad0(1:nbdirs0, 0, is)/g" b2tqna_dv_dv.F90
sed -i -e "s/cfvla(0, is), cfvlad0(:, 0, is)/cfvla(0, is), cfvlad0(1:nbdirs0, 0, is)/g" b2tqna_dv_dv.F90
sed -i -e "s/cfhci(0, is), cfhcid0(:, 0, is)/cfhci(0, is), cfhcid0(1:nbdirs0, 0, is)/g" b2tqna_dv_dv.F90
sed -i -e "s/cfdpa(0, is), cfdpad0(:, 0, is)/cfdpa(0, is), cfdpad0(1:nbdirs0, 0, is)/g" b2tqna_dv_dv.F90
sed -i -e "s/cfvsa(0, is), cfvsad0(:, 0, is)/cfvsa(0, is), cfvsad0(1:nbdirs0, 0, is)/g" b2tqna_dv_dv.F90
...
sed -i '/EXTERNAL ISGHOSTCELL/d' b2us_prep_diffv_diffv.F90 b2mod_geo2_diffv_diffv.F90 b2mod_geo_diffv_diffv.F90 b2mod_indirect_diffv_diffv.F90
sed -i '/LOGICAL :: ISGHOSTCELL/d' b2us_prep_diffv_diffv.F90 b2mod_geo2_diffv_diffv.F90 b2mod_geo_diffv_diffv.F90 b2mod_indirect_diffv_diffv.F90
sed -i '/EXTERNAL ISREALCELL/d' b2us_prep_diffv_diffv.F90 b2mod_geo_diffv_diffv.F90 b2mod_geo2_diffv_diffv.F90 b2mod_indirect_diffv_diffv.F90
sed -i '/LOGICAL :: ISREALCELL/d' b2us_prep_diffv_diffv.F90 b2mod_geo_diffv_diffv.F90 b2mod_geo2_diffv_diffv.F90 b2mod_indirect_diffv_diffv.F90
sed -i '/EXTERNAL ISINDOMAIN/d' b2mod_geo_diffv_diffv.F90 b2mod_geo2_diffv_diffv.F90 b2mod_indirect_diffv_diffv.F90
sed -i '/LOGICAL :: ISINDOMAIN/d' b2mod_geo_diffv_diffv.F90 b2mod_geo2_diffv_diffv.F90 b2mod_indirect_diffv_diffv.F90
sed -i '/EXTERNAL ISCLASSICALGRID/d' b2mod_geo_diffv_diffv.F90
sed -i '/LOGICAL :: ISCLASSICALGRID/d' b2mod_geo_diffv_diffv.F90
sed -i '/EXTERNAL ISBOUNDARYCELL/d' b2us_prep_diffv_diffv.F90
sed -i '/LOGICAL :: ISBOUNDARYCELL/d' b2us_prep_diffv_diffv.F90
sed -i '/EXTERNAL ISUNUSEDCELL/d' b2us_prep_diffv_diffv.F90 b2mod_geo2_diffv_diffv.F90 b2xvsg_dv_dv.F90 b2mod_geo_diffv_diffv.F90
sed -i '/LOGICAL :: ISUNUSEDCELL/d' b2us_prep_diffv_diffv.F90 b2mod_geo2_diffv_diffv.F90 b2xvsg_dv_dv.F90 b2mod_geo_diffv_diffv.F90
sed -i '/EXTERNAL ISCLASSICALGRID/d' b2us_prep_diffv_diffv.F90 
sed -i '/LOGICAL :: ISCLASSICALGRID/d' b2us_prep_diffv_diffv.F90 
...
sed -i 's/b2usr_loads/b2usr_loads_nodiff_nodiff/g' b2mod_usrtrc.F
...
sed -i -e 's/CALL MAXVAL_DV2(abs0, abs0d, result10, result10d0, nbdirs0)/result10 = MAXVAL(abs0)/g' ./b2stcx_dv_dv.F90
