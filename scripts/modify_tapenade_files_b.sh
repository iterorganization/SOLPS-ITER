...
sed -i '/POPPOINTER8/d' ./*.F90 #!FIXME
sed -i '/PUSHPOINTER8/d' ./*.F90 #!FIXME

sed -i '/CALL PUSHINTEGER4ARRAY(mpg%ictcntrl/d' ./*.F90 #!FIXME
sed -i '/CALL POPINTEGER4ARRAY(mpg%ictcntrl/d' ./*.F90 #!FIXME

sed -i -e 's/LOGICAL :: mask$/LOGICAL :: mask(-1:nx,-1:ny)/g' b2us_prep_diff.F90
...
#  private :: nsdmax in modules!!! !FIXME
...
sed -i -e 's/ISIZE1OFarg1/mpg%nCv/g' b2mod_driver_diff.F90 b2stbr_phys_b.F90
...
sed -i -e 's/ISIZE1OFfcqalf/nFc/g' b2stbc_b.F90 b2stbc_phys_b.F90 b2tfhe__b.F90 b2tfhi__b.F90 b2trno_b.F90
sed -i -e 's/ISIZE1OFcvsahz_eff/nFc/g' b2stbr_phys_b.F90
sed -i -e 's/ISIZE2OFcvsahz_eff/0:1/g' b2stbr_phys_b.F90
sed -i -e 's/ISIZE1OFcvsahz/nFc/g' b2stbr_phys_b.F90
sed -i -e 's/ISIZE2OFcvsahz/0:1/g' b2stbr_phys_b.F90
...
sed -i -e 's/ISIZE1OFcvbb/nCv/g' b2tfnb_b.F90 
...
#sed -i -e 's/CHARACTER(len=\*) :: name/CHARACTER(len=7) :: name/g' b2usco_b.F90 b2usmo_b.F90
#sed -i -e 's/SIZE(name, 1)/len(name)/g' b2usco_b.F90 b2usmo_b.F90
sed -i '/PUSHCHARACTERARRAY(name/d' b2usco_b.F90 b2usmo_b.F90 #CHECK
sed -i '/POPCHARACTERARRAY(name/d' b2usco_b.F90 b2usmo_b.F90 #CHECK
sed -i -e 's/DIMENSION(mpg%cvnvp(icv., 2))/DIMENSION(11)/g' b2usco_b.F90 b2usht_b.F90 b2usmo_b.F90 b2uspo_b.F90 #careful with this!
