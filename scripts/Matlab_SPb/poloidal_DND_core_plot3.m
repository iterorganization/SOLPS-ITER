function iout=poloidal_DND_core_plot3(x2,value1,value2,value3,nb1,ne1,nb2,ne2,npl,Gtitle,Ylabel,label1,label2,label3);
...
legend(label1,label2,label3,'interpreter','latex','FontName','Times','FontSize',24);
