function iout=poloidal_plot_4_1D_profiles(x2,value1,value2,value3,value4,...
    nb1,ne1,nb2,ne2,npl,Gtitle,Ylabel,label1,label2,label3,label4);
...
value(ne1-nb1+2:(ne1-nb1)+1+(ne2-nb2)+1)=value1(nb2+2:ne2+2);
...
value(ne1-nb1+2:(ne1-nb1)+1+(ne2-nb2)+1)=value2(nb2+2:ne2+2);
...
xlabel('Distance from inner target, m','FontName','Times','FontSize',36);
...
legend(label1,label2,label3,label4,'interpreter','latex','FontName','Times','FontSize',24,'Location','best');
