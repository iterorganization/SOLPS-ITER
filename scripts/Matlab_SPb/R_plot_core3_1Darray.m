function iout = R_plot_core3_1Darray(y,Flux_flag,value1,value2,value3,nsep,npl,Gtitle,Ylabel,label1,label2,label3);
...
if Flux_flag == 0
    ...
    plot(y(2:nsep+2,npl+2),value3(2:nsep+2),'-*','Color',[0.75,0.2,0.15],'LineWidth',3);
elseif Flux_flag == 1
