function iout = R_plot_9(length,Plot_Flag,value1,value2,value3,value4,value5,value6,value7,value8,value9,ny,npl,Gtitle,Ylabel,label1,label2,label3,label4,label5,label6,label7,label8,label9);
...
plot(length(i_begin:i_end,npl+2),value9(i_begin:i_end,npl+2),'-+','Color',[0.5,0.5,1],'LineWidth',2);
