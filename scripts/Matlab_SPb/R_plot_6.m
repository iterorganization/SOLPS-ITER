function iout = R_plot_6(length,Plot_Flag,value1,value2,value3,value4,value5,value6,ny,npl,Gtitle,Ylabel,label1,label2,label3,label4,label5,label6);
...
hold all;
plot(length(i_begin:i_end,npl+2),value2(i_begin:i_end,npl+2),'-ob','LineWidth',2);
...
plot(length(i_begin:i_end,npl+2),value6(i_begin:i_end,npl+2),'-h','Color',[0.25,0.5,0.25],'LineWidth',2);
...
legend(label1,label2,label3,label4,label5,label6,'interpreter','latex','FontName','Times','FontSize',24);
grid on;
grid minor;
