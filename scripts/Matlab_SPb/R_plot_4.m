function iout = R_plot_4(length,Plot_Flag,value1,value2,value3,value4,ny,npl,Gtitle,Ylabel,label1,label2,label3,label4);
...
hold all;
plot(length(i_begin:i_end,npl+2),value3(i_begin:i_end,npl+2),'-s','Color',[0.75,0,1],'LineWidth',2);
hold all;
plot(length(i_begin:i_end,npl+2),value4(i_begin:i_end,npl+2),'-s','Color',[0.0,0,0],'LineWidth',2);
