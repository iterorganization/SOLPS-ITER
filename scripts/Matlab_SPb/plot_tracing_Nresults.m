...
trc_Ncore = zeros(max(size_of_trc),Nresults);
trc_Ntot = zeros(max(size_of_trc),Nresults);
trc_Dcore = zeros(max(size_of_trc),Nresults);
trc_Dtot = zeros(max(size_of_trc),Nresults);
trc_Nbln = zeros(max(size_of_trc),Nresults);
trc_Dbln = zeros(max(size_of_trc),Nresults);
