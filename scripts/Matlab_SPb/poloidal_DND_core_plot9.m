function iout=poloidal_DND_core_plot9(x2,value1,value2,value3,value4,value5,value6,value7,value8,value9,nb1,ne1,nb2,ne2,npl,Gtitle,Ylabel,label1,label2,label3,label4,label5,label6,label7,label8,label9);


% Plots nine VALUEs versus poloidal coordinate in the core and in any other
...
plot(xx,value,'-s','LineWidth',2,'Color',[0.25,0.5,0.25]);
hold all;
...
legend(label1,label2,label3,label4,label5,label6,label7,label8,label9,'interpreter','latex','FontName','Times','Location','best');
