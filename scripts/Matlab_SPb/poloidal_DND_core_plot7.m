function iout=poloidal_DND_core_plot7(x2,value1,value2,value3,value4,value5,value6,value7,nb1,ne1,nb2,ne2,npl,Gtitle,Ylabel,label1,label2,label3,label4,label5,label6,label7);

% Plots seven VALUEs versus poloidal coordinate in the coreand in any other
...
legend(label1,label2,label3,label4,label5,label6,label7,'interpreter','latex','FontName','Times','FontSize',24);
