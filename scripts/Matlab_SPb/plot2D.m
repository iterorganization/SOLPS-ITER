...
value1(:,1:nc1+1)=value(1:ny+2,1:nc1+1);
for i=1:ny+2
...
value1(:,2:nx-nc4+1)=value(1:ny+2,nc4+3:nx+2);
for i=1:ny+2
...
value1(:,2:ntt-nc2+1)=value(1:ny+2,nc2+3:ntt+2);
for i=1:ny+2
...
value1(:,1:nc3-ntt-1)=value(1:ny+2,ntt+3:nc3+1);
for i=1:ny+2
...
value1(:,2:nc2-nc1+2)=value(1:ny+2,nc1+2:nc2+2);
for i=1:ny+2
...
value1(:,2:nc4-nc3+2)=value(1:ny+2,nc3+2:nc4+2);
for i=1:ny+2
