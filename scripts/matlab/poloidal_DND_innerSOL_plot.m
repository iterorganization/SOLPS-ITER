function iout=poloidal_DND_innerSOL_plot(x2,value,nc2,nc3,nx,npl,Gtitle,Ylabel);
...
plot(x2(npl,1:nc2+2),value(npl,1:nc2+2),'-s','LineWidth',2,'Color',[1,0,0]);
hold all;
plot(x2(npl,nc3+2:nx+2),value(npl,nc3+2:nx+2),'-s','LineWidth',2,'Color',[1,0,0]);
hold all;
