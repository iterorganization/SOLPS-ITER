function iout = R_plot_3(length,value1,value2,value3,nx,ny,npl,Gtitle,Ylabel,label1,label2,label3);
...
plot(length(1:ny+1,npl+2),value3(1:ny+1,npl+2),'-s','Color',[0.45,0.1,0.05],'LineWidth',2);
