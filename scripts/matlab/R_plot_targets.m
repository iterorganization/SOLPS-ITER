function iout = R_plot_targets(y,value,flux_flug,nx,ny,ntt,nc2,nc3,Ylabel,Gtitle);
...
if ntt==nc2 || ntt==nc3
    legend('inner bottom target','outer bottom target','FontName','Times','FontSize',22,'Location','NorthEast');
else
