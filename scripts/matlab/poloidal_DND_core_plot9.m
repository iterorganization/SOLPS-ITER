...
% Plots seven VALUEs versus poloidal coordinate in the core
...
legend(label1,label2,label3,label4,label5,label6,label7,label8,label9,'interpreter','latex','FontName','Times','FontSize',24);
