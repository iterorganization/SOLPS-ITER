function iout=poloidal_DND_core_plot12(x2,value1,value2,value3,value4,value5,value6,value7,value8,value9,value10,value11,value12,...
    nb1,ne1,nb2,ne2,npl,Gtitle,Ylabel,label1,label2,label3,label4,label5,label6,label7,label8,label9,label10,label11,label12);

% Plots 12 VALUEs versus poloidal coordinate in the core
...
legend(label1,label2,label3,label4,label5,label6,label7,label8,label9,label10,label11,label12,'interpreter','latex','FontName','Times','FontSize',24);
