function aver = read_b2favere(file)
% gmtry = read_b2favere(file)
%
...
% Get version of the b2favere file

line    = fgetl(fid);
version = line(8:17);

disp(['read_b2favere -- file version ',version]);
line = fgetl(fid);
