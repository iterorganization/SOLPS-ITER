function [Sh,seph,strh] = Surfplot(structure,gmtry,field,varargin)
% [Sh,seph,strh]= Surfplot(structure,gmtry,field,scale,fmin,fmax)
%
...
% Output arguments:
%
% - Sh   : handle to the surface object
...
figure; hold on;
Sh   = surfplot(gmtry,field,varargin{:});
