...
sed -i '/&                           , geo, geod, j, jd, nbdirs)/d' b2mod_driver_diffv.F90
...
sed -i -e "/B2USR_COST_FUNCTION_DV/a\&                           , geo, geod, j, jd, nbdirs)" b2mod_driver_diffv.F90
...
sed -i -e '/switchd%keps_cd(nd) = 0.D0/d' b2tqna_dv.F90
sed -i -e '/switchd%keps_heat(nd) = 0.D0/d' b2tqna_dv.F90
sed -i -e '/switchd%keps_heat_i(nd) = 0.D0/d' b2tqna_dv.F90
