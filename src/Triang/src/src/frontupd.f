...
C----         POINT IB AND ENDS AT POINT INODCON
C---- K : LOOP INDEX
C---- NP : TOTAL NUMBER OF FRONTIER PARTS ON INPUT OF SUBROUTINE
C---- NE : TOTAL NUMBER OF ELEMENTS ON INPUT OF SUBROUTINE
C---- BOUND, IND1, IND2, IHELP, HELP : AUXILARY VARIABLES FOR SORTING
      INTEGER J,INODA,INODB,K,BOUND,IND1,IND2,IHELP,NP,NE,IE
