...
\begin{tabular}{L{2cm} L{8cm}}
	$e$ &  Elementary charge, $1.6022\cdot10^{-19}~C$ \\
\end{tabular}
...
\begin{tabular}{L{2cm} L{12cm}}
	...
	$\tau$ & Tangential direction perpendicular to the normal and toroidal direction \\
	$\phi$ & Toroidal direction \\
	$||$ & Parallel direction \\
	$\perp$ & Diamagnetic direction
\end{tabular}
