...
\begin{align}
   \rconei & (u_{a,\phi},T_a,\dshpot) = \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^4} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rv (v')^3  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta') \sin (\vartheta')
...
\begin{align}
    ...
    \Rv (v')^4  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta')^2 \sin (\vartheta')
...
\begin{align}
    \mathrm{RC}_n^{\dnndy} & (u_{a,\phi},T_a,\dshpot) =
     \frac{1}{\pi^{\frac{3}{2}}} \frac{1}{\ca^{5} }\int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rv (v')^4  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta') \sin (\vartheta')^2 \sin(\varphi')
...
\begin{align}
    \rmxonei & (u_{a,\phi},T_a,\dshpot) =
         \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^5} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rmomparv (v')^4  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta') \sin (\vartheta')^2 \cos (\varphi')
...
\begin{align}
    ...
    \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^6} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rmomparv (v')^5  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta') \sin (\vartheta')^3 \cos(\varphi') \sin(\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
\begin{align}
    \mathrm{R}_{\mathrm{m},\tau} & (u_{a,\phi},T_a,\dshpot) =
         \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^5} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rmomparv (v')^4  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta') \sin (\vartheta')^2 \sin (\varphi') \cos(\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
\begin{align}
    \rmytwoi & (u_{a,\phi},T_a,\dshpot) =
      \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^6} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rmomparv (v')^5  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta') \sin (\vartheta')^3 \sin (\varphi')^2
...
\begin{align}
    \rmztwoi & (u_{a,\phi},T_a,\dshpot) =
        \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^6} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rmomperpv (v')^5  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta')^3 \sin (\vartheta')
...
\begin{align}
    \mathrm{RC}_{\mathrm{m},\nu}^{\dnndy} & (u_{a,\phi},T_a,\dshpot) =
        \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^6} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rmomperpv (v')^5  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \cos (\vartheta')^2 \sin (\vartheta')^2 \sin(\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
\begin{align}
    \rponeonei & (u_{a,\phi},T_a,\dshpot) =
        \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^5} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rpvone (v')^4  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right) \sin (\vartheta')
...
\begin{align}
    ...
    \Rpvone (v')^2  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right)  \sin (\vartheta')^2 \sin(\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
\begin{align}
    ...
    \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^4} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rpvthree (v')^3  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right)  \sin (\vartheta')^2 \cos (\varphi')
...
\begin{align}
    ...
    \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^5} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi}
    \Rpvthree (v')^4  \nonumber \\
    & \exp \left( - \frac{m}{2 T_a} \left( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \right) \right)  \cos (\vartheta') \sin (\vartheta')^3 \sin (\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
with
\begin{align}
    \fmozincd & = m \frac{\vcx}{\vtot} \left( - \nn \itwol + \frac{1}{\vtot} ( \dnndy \uy \itwol + \dnndz \ithreel ) \right), \\
    \fmoyincd & = m \frac{\vcx}{\vtot} \left( - \nn \uy \ionel + \frac{1}{\vtot} \left( \dnndy (\frac{\Ti}{m} + \uy^2) \ionel + \dnndz \uy \itwol \right) \right),\\
    \fmoxincd & = m \frac{\vcx}{\vtot} \left( - \nn \ux \ionel + \frac{1}{\vtot} ( \dnndy \ux \uy \ionel + \dnndz \ux \itwol) \right).
\end{align}
...
\begin{align}
    ...
    Q^{\mathrm{n,diff}}_{\mathrm{inc}} & = \frac{\vcx}{\vtot} \left( -\nn \left( \left(\Ti + \frac{m}{2} \left( \ux^2 + \uy^2 \right) \right) \ionel + \frac{m}{2} \ithreel \right) \nonumber \right. \\ & + \frac{1}{\vtot} \left( \dnndy \left( \left( 2 \Ti + \frac{m}{2} \left( \ux^2 + \uy^2 \right) \right) \uy \ionel + \frac{m}{2} \uy \ithreel \right) \right. \nonumber \\
    & + \left. \left. \dnndz \left( \left( \Ti + \frac{m}{2} \left( \ux^2 + \uy^2 \right) \right) \itwol + \frac{m}{2} \ifourl \right) \right) \right), \\
