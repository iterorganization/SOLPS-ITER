...
The sheath acceleration is determined by $\Delta \phi_{\mathrm{sh}} = \dshpot \Te e^{-1}$, while the macroscopic reflection coefficients are tabulated as a function of $T_\mathrm{i/n}$. This is solved by evaluating the database for 
\begin{equation}
...
\begin{align}
   \rconei & (u_{a,\phi},T_a,\dshpot) = \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^4} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rv (v')^3  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta') \sin (\vartheta')
...
\begin{align}
    ...
    \Rv (v')^4  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta')^2 \sin (\vartheta')
...
\begin{align}
    \mathrm{RC}_n^{\dnndy} & (u_{a,\phi},T_a,\dshpot) = 
     \frac{1}{\pi^{\frac{3}{2}}} \frac{1}{\ca^{5} }\int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rv (v')^4  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta') \sin (\vartheta')^2 \sin(\varphi')
...
\begin{align}
    \rmxonei & (u_{a,\phi},T_a,\dshpot) = 
         \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^5} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rmomparv (v')^4  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta') \sin (\vartheta')^2 \cos (\varphi')
...
\begin{align}
    ...
    \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^6} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rmomparv (v')^5  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta') \sin (\vartheta')^3 \cos(\varphi') \sin(\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
\begin{align}
    \mathrm{R}_{\mathrm{m},\tau} & (u_{a,\phi},T_a,\dshpot) = 
         \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^5} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rmomparv (v')^4  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta') \sin (\vartheta')^2 \sin (\varphi') \cos(\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
\begin{align}
    \rmytwoi & (u_{a,\phi},T_a,\dshpot) = 
      \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^6} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rmomparv (v')^5  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta') \sin (\vartheta')^3 \sin (\varphi')^2
...
\begin{align}
    \rmztwoi & (u_{a,\phi},T_a,\dshpot) = 
        \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^6} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rmomperpv (v')^5  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta')^3 \sin (\vartheta')
...
\begin{align}
    \mathrm{RC}_{\mathrm{m},\nu}^{\dnndy} & (u_{a,\phi},T_a,\dshpot) = 
        \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^6} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rmomperpv (v')^5  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \cos (\vartheta')^2 \sin (\vartheta')^2 \sin(\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
\begin{align}
    \rponeonei & (u_{a,\phi},T_a,\dshpot) = 
        \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^5} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rpvone (v')^4  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big) \sin (\vartheta')
...
\begin{align}
    ...
    \Rpvone (v')^2  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big)  \sin (\vartheta')^2 \sin(\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
\begin{align}
    ...
    \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^4} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rpvthree (v')^3  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big)  \sin (\vartheta')^2 \cos (\varphi')
...
\begin{align}
    ...
    \frac{1}{\pi^\frac{3}{2}} \frac{1}{\ca^5} \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} 
    \Rpvthree (v')^4  \nonumber \\ 
    & \mathrm{exp}\Big( - \frac{m}{2 T_a} \big( (v')^2-2 (v') u_{a,\phi} \mathrm{sin}(\vartheta') \mathrm{cos}(\varphi') + u_{a,\phi}^2 - \frac{2 \dshpot T_a}{m} \big) \Big)  \cos (\vartheta') \sin (\vartheta')^3 \sin (\varphi')
    \dd v' \dd \vartheta' \dd \varphi' = 0.
\end{align}
...
& -
\pit \cosa (p^\mathrm{n,diff/maxw}_\mathrm{1,rec} + p^\mathrm{n,diff/maxw}_\mathrm{1,refl} + p^\mathrm{n}_\mathrm{1,T,rec} + 
p^\mathrm{n,diff/maxw}_\mathrm{1,T,refl} -
p^\mathrm{n,diff/maxw}_\mathrm{1,T,inc} + p_2)  \label{eq:par_mom_final}
\end{align}
...
\begin{equation}
    \Gamma^\mathrm{n}_\mathrm{m,||,rec} = \pit (\fmozrec \cosa - \fmoyrec \sina) - \pitt \fmoxrec
\end{equation}
with
\begin{align}
...
where $ \pcorfi = \frac{\mathrm{min}(\pfi,\Rifl)}{\pfi}$ with
...
\begin{equation}
    \Gamma^\mathrm{n,diff}_\mathrm{m,||,refl} = \pit (\fmozrefld \cosa - \fmoyrefld \sina) - \pitt \fmoxrefld
\end{equation}
with
\begin{align}
    \fmozrefld & = \pcorfnd m \frac{\vcx}{\vtot} \big( \nn \rmzonei \ci^2 + \frac{1}{\vtot} \dnndz \rmztwoi \ci^3 \big),\\
    \fmoyrefld & = \pcorfnd m \frac{\vcx}{(\vtot)^2} \dnndy \rmytwoi \ci^3, \\
    \fmoxrefld & = \pcorfnd m \frac{\vcx}{\vtot} \big( \nn \rmxonei \ci^2 + \frac{1}{\vtot} \dnndz \rmxtwoi \ci^3 \big),
\end{align}

where $ \pcorfnd = \frac{\mathrm{min}(\pfnd,\Rnxfl)}{\pfnd}$ with

\begin{equation}
    \pfnd = \frac{\vcx}{\vtot} ( \nn \rconei \ci + \frac{1}{\vtot}\dnndz \rctwoi \ci^2) \frac{1}{\fnnid}.
\end{equation}

When using the drifting Maxwellian approximation, the fast reflected parallel momentum flux becomes
\begin{equation}
    \Gamma^\mathrm{n,maxw}_\mathrm{m,||,refl} = \pit (\fmozreflm \cosa - \fmoyreflm \sina) - \pitt \fmoxreflm
\end{equation}
...
where $ \pcorfnm = \frac{\mathrm{min}(\pfnm,\Rnxfl)}{\pfnm}$ with
...
%    \Gamma^\mathrm{n}_\mathrm{m,||,T,rec} = \pit (\fmozrect \cosa + \fmoyrect \sina) + \pitt \fmoxrect
...
where $\pti = \mathrm{max}(\Rifl-\pfi,0)$.
...
where $\ptnd = \mathrm{max}(\Rnxfl-\pfnd,0)$. When using the drifting Maxwellian assumption, this becomes
...
\begin{equation}
    \Gamma^\mathrm{n,diff}_\mathrm{m,||,inc} = \pit (\fmozincd \cosa - \fmoyincd \sina) - \pitt \fmoxincd
\end{equation}

with
\begin{align}
    \fmozincd & = m \frac{\vcx}{\vtot} \big( - \nn \itwol + \frac{1}{\vtot} ( \dnndy \uy \itwol + \dnndz \ithreel ) \big), \\
    \fmoyincd & =  m \frac{\vcx}{\vtot} \Big(-\nn \uy \ionel + \frac{1}{\vtot} \big( \dnndy (\frac{\Ti}{m} + \uy^2) \ionel + \dnndz \uy \itwol \big) \Big),\\
    \fmoxincd & =  m \frac{\vcx}{\vtot} \big( - \nn \ux \ionel + \frac{1}{\vtot} ( \dnndy \ux \uy \ionel + \dnndz \ux \itwol) \big).
\end{align}

When using the drifting Maxwellian approximation, this becomes
\begin{equation}
    \Gamma^\mathrm{n,maxw}_\mathrm{m,||,inc} =  -\pit (\fmozincm \cosa + \fmoyincm \sina) - \pitt \fmoxincm
\end{equation}
...
\begin{equation}
    p^\mathrm{n,diff}_\mathrm{1,refl} = \pcorfnd \frac{m}{3} \frac{\vcx}{\vtot} \big( \nn + \rponeonei \ci^2 + \frac{1}{\vtot} \dnndz \rponetwoi \ci^3 \big),
\end{equation}
...
\begin{align}
    ...
    \frac{m}{3} \frac{\vcx}{\vtot} \Bigg( \nn \bigg( \big( \frac{2 \Ti}{m} + \ux^2 + \uy^2 \big) \izerol + \itwol \bigg)  \\ & - \frac{1}{\vtot} \bigg( \dnndy \big( ( \frac{4 \Ti}{m} \uy  + \ux^2 \uy + \uy^3) \izerol + \uy \itwol \big) + \dnndz \big( (  \frac{2 \Ti}{m} + \ux^2 + \uy^2)  \ionel + \ithreel \big) \bigg) \Bigg),
\end{align}

\begin{equation}
    p^\mathrm{n,maxw}_\mathrm{1,inc} =   
    \frac{m}{3} \bigg(\nn  \big( (\frac{2 T_\mathrm{n}}{m} + \uxn^2 + \uyn^2) \izerol + \itwol \big) \bigg). 
\end{equation}
...
\begin{align}
    ...
    %-------
    (\nn')_\mathrm{refl}^\mathrm{diff} & = \pcorfnd \frac{\vcx}{\vtot} \big( \nn \rptwoonei + \frac{1}{\vtot} \dnndz \rptwotwoi \ci\big), \\  
    %-------
    ...
    %-------
    (\nn')_\mathrm{inc}^\mathrm{diff} & = \frac{\vcx}{\vtot} \big( \nn \izerol - \frac{1}{\vtot} (\dnndy \uy \izerol + \dnndz \ionel) \big), \\ 
    %-------
...
\begin{align}
    ...
    %-------
    (\nn' \wwn')_\mathrm{refl}^\mathrm{diff} & = \pcorfnd \frac{\vcx}{\vtot} \big( \nn \rpthreeonei \ci + \frac{1}{\vtot} \dnndz \rpthreetwoi \ci^2 \big), \\ 
    %-------
...
Using the definitions of $\reonei$ (Eq. \eqref{eq:reonei_def}) and $\retwoi$ (Eq. \eqref{eq:retwoi_def}), the components are written as  

\begin{align}
    Q^\mathrm{n}_\mathrm{rec} & = \frac{1}{2} \pcorfi m \reonei \ci^3 \frac{\fdni}{-\ionel}, \\
    Q^\mathrm{n,diff}_\mathrm{refl} & = \frac{1}{2} \pcorfnd m \frac{\vcx}{\vtot} \big(-\nn \reonei \ci^3 + \frac{1}{\vtot} \dnndz \retwoi \ci^4\big), \\ 
    ...
    Q^\mathrm{n,diff}_{\mathrm{inc}} & = \frac{\vcx}{\vtot} \Bigg( -\nn \bigg( \Big(\Ti + \frac{m}{2} \big(\ux^2 + \uy^2 \big) \Big) \ionel + \frac{m}{2} \ithreel \bigg) + \nonumber \\ & \frac{1}{\vtot} \bigg(\dnndy \Big( \big(2 \Ti + \frac{m}{2}(\ux^2 + \uy^2) \big) \uy \ionel + \frac{m}{2} \uy \ithreel \Big) + \nonumber \\
    & \dnndz \Big( \big(\Ti + \frac{m}{2} (\ux^2 + \uy^2) \big) \itwol + \frac{m}{2} \ifourl \Big) \bigg) \Bigg), \\
    Q^\mathrm{n,maxw}_{\mathrm{inc}} & = -\nn \Big( \big( \Tn + \frac{m}{2} ( \uxn^2 + \uyn^2) \big) \ionel + \frac{m}{2} \ithreel \Big). 
\end{align}
...
\underline{Symbol} & \underline{Code} \\
$e$ & \texttt{qe} \\
$\nn$ & \texttt{nnf} / \texttt{nn} \\
$\pit$ & \texttt{pit} \\
$\pitt$ & \texttt{pit2} \\
$\pfi / \pfn$ &  \texttt{pf}\\
$\pcorfi / \pcorfn$ &  \texttt{pcorf}\\
$\pti / \ptn $ &  \texttt{pt}\\
$\Rnxfl / \Rifl$ &  \texttt{recyc0} / \texttt{b2recyc} \\
$\recycm$ & \texttt{recycm}\\
$\cosa$ & \texttt{cosa} \\
$\sina$ & \texttt{sina} \\
$\phi$ & \texttt{x} \\
...
\underline{Symbol} & \underline{Code} \\
$\fmoxincd / \fmoxincm$ &  \texttt{fmox} \\
$\fmoyincd / \fmoyincm$ &  \texttt{fmoy} \\
$\fmozincd / \fmozincm$ &  \texttt{fmoz} \\
$ \Gamma^\mathrm{n,diff}_\mathrm{m,||,inc} /  \Gamma^\mathrm{n,maxw}_\mathrm{m,||,inc} $ &  \texttt{fmomni} \\
$Q^\mathrm{n,diff}_{\mathrm{inc}} / Q^\mathrm{n,maxw}_{\mathrm{inc}}$ &  \texttt{feneni} \\
$(\nn')_\mathrm{inc}^\mathrm{diff} / (\nn')_\mathrm{inc}^\mathrm{maxw}$ &  \texttt{nni} \\
$ (\nn' \wwn')_\mathrm{inc}^\mathrm{diff}$ &  \texttt{nnwwni} \\
$p^\mathrm{n,diff}_\mathrm{1,inc} / p^\mathrm{n,maxw}_\mathrm{1,inc}$&  \texttt{pn} \\
\end{tabular}
...
\underline{Symbol} & \underline{Code} \\ 
$\fmoxrefld / \fmoxreflm$ &  \texttt{fmox} \\ 
$\fmoyrefld / \fmoyreflm$ &  \texttt{fmoy} \\ 
$ \fmozrefld / \fmozreflm + \fmozrefldt / \fmozreflmt$ &  \texttt{fmoz} \\ 
