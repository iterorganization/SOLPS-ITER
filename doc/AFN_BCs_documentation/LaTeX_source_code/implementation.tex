...
with
\begin{align}
    \fmozrec & = \pcorfi \ m \rmzonei \ci^2 \left( - \frac{\fdni}{\ionel} \right), \\
    \fmoyrec & = 0, \\
    \fmoxrec & = \pcorfi \ m \rmxonei \ci^2 \left( - \frac{\fdni}{\ionel} \right),
\end{align}
...
\begin{equation}
     p^{\mathrm{n}}_{\mathrm{1,rec}} = \pcorfi \frac{m}{3} \rponeonei \ci^2 \left( - \frac{\fdni}{\ionel} \right),
\end{equation}
...
\begin{align}
    (\nn')_{\mathrm{rec}} & = \pcorfi \rptwoonei \left( - \frac{\fdni}{\ionel} \right), \\
    %-------
...
\begin{align}
    (\nn' \wwn')_{\mathrm{rec}} & = \pcorfi \rpthreeonei \ci \left( - \frac{\fdni}{\ionel} \right), \\
    %-------
...
\begin{align}
    Q^{\mathrm{n}}_{\mathrm{rec}} & = \frac{1}{2} \pcorfi m \reonei \ci^3 \left( - \frac{\fdni}{\ionel} \right), \\
