...
The AFN BCs were primarily developed in the PhD thesis of N. Horsten \cite{phd_niels} in an in-house code. Subsequently, the models have been integrated and tested in SOLP-ITER by M. Blommaert et al. \cite{pet_maarten} (structured version) and W. Van Uytven et al. \cite{wim2022} (unstructured version).
