...
\Gammanb{T} =&  \int_{v'=0}^{\infty} \int_{\vartheta'=0}^{\pi/2} \int_{\varphi'=0}^{2\pi} \left( 1 - R_{\mathrm{N}}(v',\vartheta') \right) \left( \Rnx \Gammanmin(v',\vartheta',\varphi') \nonumber \right. \\
& \left. + \Ri \Gammaimin(v',\vartheta',\varphi') \right) \dd v' \dd \vartheta' \dd \varphi'. \label{eq:GammanT}
\end{align}
...
\ldots & \dd v \dd \vartheta \dd \varphi. \label{eq:Rnn}
\end{align}
