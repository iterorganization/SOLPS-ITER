...
\begin{itemize}
    \item Horsten, N., Dekeyser, W., Samaey, G., B\"orner, P., \& Baelmans, M. (2016). Fluid neutral model for use in hybrid neutral simulations of a detached case. Contributions to Plasma Physics, 56(6‐8), 610-615. \newline \newline
    AFN in 1D in MATLAB
    ...
    AFN in 2D in MATLAB
    \item Blommaert, M., Dekeyser, W., Horsten, N., B\"orner, P., \& Baelmans, M. (2018). Implementation of a consistent fluid‐neutral model in SOLPS‐ITER and benchmark with EIRENE. Contributions to Plasma Physics, 58(6-8), 718-724. \newline \newline
