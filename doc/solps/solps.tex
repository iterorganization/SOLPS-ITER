...
%% Special thanks to Anastasia Dvornova for typing up this chapter in LaTeX
\scriptsize{
...
\begin{matrix}
12 \\
max \{ 5; 23.4 - 1.15 \cdot log_{10} \left( \frac{n_e}{10^6} \right) + 3.45 \cdot log_{10} \left( \frac{T_e}e \right)  \}, & \frac{T_e}{e} \leq 50 & \mbox{\scriptsize{Braginsky formula}} \\
max \{ 5; 25.3 - 1.15 \cdot log_{10} \left( \frac{n_e}{10^6} \right) + 2.30 \cdot log_{10} \left( \frac{T_e}e \right)  \}, & \frac{T_e}{e} > 50  \\
max \{ 5; 17.3 - 0.5 \cdot log_e \left( \frac{n_e}{10^{20}} \right) + 1.5 \cdot log_e \left( \frac{T_e}{e \cdot 10^3} \right)  \} & \mbox{\tiny{Wessom formula}} &\mbox{\tiny{for ion-ion collisions}}\\
\end{matrix} \right.
\end{matrix}
\end{equation}
...
% proverit, ne nuzhen li coeff 4\3 pered \eta vo 2-om ur-ii
\begin{equation}
\begin{matrix}
\Gamma^m_{ax} & =
& \left\{
...
z_a = 1 \text{ and } z_n = 1 \\
m_a V_{\parallel a} \Gamma_{ax} + m_a V_{\parallel a} \Gamma_{ax}^{\left( dia \right)} -
\eta_{ax} \frac{\partial V_{\parallel a}}{h_x \partial x}, & \text{else}     
\end{matrix} \right.
\end{matrix}
\end{equation}

\begin{equation}
\Gamma^m_{ax} = m_a V_{\parallel a} \Gamma_{ay} +
m_a V_{\parallel a} \Gamma_{ay}^{\left( dia \right)} -
\eta_{ay} \frac{\partial V_{\parallel a}}{h_y \partial y}
\end{equation}

%-------- end of 6th page -------------

$\Gamma^m_{ax} = n_a \widetilde{V}^{\left( dia \right)}_{\perp a}$,
$\;\;\; \Gamma^m_{ay} = n_a \widetilde{V}^{\left( dia \right)}_{ya}$,
...
max \{ 5; 23.4 - 1.15 \cdot log_{10} \left( \frac{n_e}{10^6} \right) + 3.45 \cdot log_{10} \left( \frac{T_e}e \right)  \}, & \frac{T_e}{e} \leq 50 & \mbox{\scriptsize{Braginsky formula}} \\
max \{ 5; 25.3 - 1.15 \cdot log_{10} \left( \frac{n_e}{10^6} \right) + 2.30 \cdot log_{10} \left( \frac{T_e}e \right)  \}, & \frac{T_e}{e} > 50  \\
max \{ 5; 17.3 - 0.5 \cdot log_e \left( \frac{n_e}{10^{20}} \right) + 1.5 \cdot log_e \left( \frac{T_e}{e \cdot 10^3} \right)  \} & \mbox{\tiny{Wesson formula}} & \mbox{\tiny{for ion-ion collisions}} \\
\end{matrix} \right.
\end{matrix}
$
...
max \{ 5; 25.3 - 1.15 \cdot log_{10} \left( \frac{n_e}{10^6} \right) + 2.30 \cdot log_{10} \left( \frac{T_e}e \right)  \}, & \frac{T_e}{e} > 50  \\
max \{ 5; 17.3 - 0.5 \cdot log_e \left( \frac{n_e}{10^{20}} \right) + 1.5 \cdot log_e \left( \frac{T_e}{e \cdot 10^3} \right)  \} && \text{Wessom formula for ion-ion collisions} \\
\end{matrix} \right.
\end{matrix}
$
...
\begin{equation*}
\widetilde{f}_{ex} = \frac 3 2 \Gamma_{ex} + V_{ex}^{(Str)} n_e - 0.71 b_x \frac{j_{\parallel}}e
\end{equation*}
...
q_{ex} = 
\left[
	\frac 3 2 \Gamma_{ex} - 0.71 b_x \frac{j_{\parallel}} e -
...
$\Gamma_{ex} = \sum \limits_{a=0}^{n_s-1} z_a \Gamma_{ax}^{(he)} - \frac{b_x j_{\parallel}} e$,
...
new Zhdanovs expression

$z_{eff} = \frac{\sum \limits_{a=0}^{n_s-1} z_a^2n_a}{n_e}$,

$V_{e \parallel} = \frac 1{e n_e} \left[
\sum \limits_a z_a e n_a V_{a\parallel} - j_{\parallel}
\right]$,

$j_{\parallel} = \sigma_{\parallel} \hat E_x - \alpha_{ex} \frac 1{h_x} \frac{\partial T_e}{\partial x}$,

$\hat E_x = \frac 1{en_e h_x} \frac{\partial n_e T_e}{\partial x} - \frac 1{h_x} \frac{\partial \varphi}{\partial x}$,

$\sigma_{\parallel} = \sigma_{AN \parallel} + \widetilde{\sigma}_{CL \parallel} b_x$,
...
$\sigma_{CL \parallel} = \frac{e^2}{m_e} f_{\sigma_e} \left( z_{eff} \right) n_e \tau_e$,
...
$\alpha_{CLx} = \sqrt{\frac 5 2} \frac e{m_e} f_{\alpha} \left(z_{eff} \right) n_e \tau _e$,
...
$\kappa_{ix} = \kappa_i^{(AN)} + \widetilde{\widetilde{\kappa}}_{ix}^{(CL)} b_x^2$,
...
$j_x = \widetilde j_x^{(dia)} + j_x^{(in)} + \widetilde j_x^{(vis \parallel)} + \widetilde j_x^{(vis \perp)}
+ \widetilde j_x^{(visq)} + \widetilde j_x^{(s)} + b_x j_{\parallel}$,
...
$j^{AN} = - \sigma_{ANy} \frac{\partial \varphi}{h_y \partial y} $
...
p_{m,a,2} \frac{\sqrt g}{h_y} V_{\parallel a}\right] \Biggl|_{S_1}$ \ \ \ \ \ weak velocity (4) dpc
