...
The \SOLPSITER Git repository also includes the repositories for {\tt B2.5}, {\tt EIRENE}, {\tt Carre} and {\tt DivGeo} individually as submodules.
...
\item[GR] plotting library (optional, developed at FZ-J{\"u}lich)
...
If your domain name is not on this list, please add it to {\tt whereami}.
