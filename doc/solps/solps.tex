...
\begin{equation}
\begin{matrix}
\frac{\sqrt g}{h_y} \widetilde{\Gamma_{ay}} \Bigl|_{S_0}& =
& \left\{
\begin{matrix}
\left[
...
\begin{equation}
\begin{matrix}
-\frac{\sqrt g}{h_y} \widetilde{\Gamma_{ay}} \Bigl|_{N}& =
& \left\{
\begin{matrix}
\left[
	\frac 1{p_{n_a,a,1}} \frac{\sqrt g}{h_y}  \left(
...
$ -h_z \frac{\sqrt g}{h_y} \Gamma_{ay}^m \biggl|_N = \left[
	p_{m,a,1} p_{m,a,2} h_z \frac{\sqrt g}{h_y} -
...
\begin{equation*}
\begin{matrix}
frac{\sqrt g}{h_y} \widetilde q_{ey} \Bigl|_{S_0}= &
& \left\{
\begin{matrix}
\left[
...
\begin{equation*}
\begin{matrix}
-frac{\sqrt g}{h_y} \widetilde q_{ey} \Bigl|_{N}= &
& \left\{
\begin{matrix}
\left[
	\frac 5 2 \sum \limits_{a=0}^{ns-1} z_a S_{n_a,0}^{no\_mdf} T_e
...
then $e_{rec,0} = 0$, $e_{rec,1} = 0.3$, $r_{rec,0} = 0$, $r_{rec,1} = 1$

else $c_{rec,0,0} = 0$, $c_{rec,1,0} = 1$, $c_{rec,0,1} = 0$, $r_{rec,1} = 0.3$
