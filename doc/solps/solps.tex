...
\begin{description}
  \item{QSUB.* or SLURM.*} Runs a stand-alone {\tt B2.5} case.
  \item{QSUB.*-gz or SLURM.*-gz} Runs a stand-alone {\tt B2.5} case where the output log file has been compressed (activated with the "-z" option).
  \item{QSUB.*\_coupled or SLURM.*\_coupled} Runs a coupled \SOLPSITER case.
  \item{QSUB.*\_coupled-gz or SLURM.*\_coupled-gz} Runs a coupled \SOLPSITER case where the output log file has been compressed (activated with the "-z" option).
