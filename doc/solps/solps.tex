...
The name {\tt AUTOMATIC\_DISTRIBUTION} refers to the MPI parallelization strategy chosen. See the {\tt Eirene\_balanced\_MPI document} on the \SOLPSITER web site {\tt Manuals and Documentation} folder for more details.
