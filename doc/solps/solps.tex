...
fniyip \index{fniyip}\index{b2time.nc, fniyip} & integrated radial particle flux, main chamber & $s^{-1}$ \\
...
fniyap \index{fniyap}\index{b2time.nc, fniyap} & integrated radial particle flux, divertor region & $s^{-1}$ \\
