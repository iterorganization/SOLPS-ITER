...
\begin{description}\index{Compiling the code}\index{B2.5, compiling}\index{SOLPS-ITER, compiling}\index{Eirene, compiling}\index{DivGeo, compiling}\index{Carre, compiling}
  ...
  \item[nox] The same as {\bf solps} above, but without linking to any graphical libraries:
    \begin{description}
      \item[Carre] The \verb!Carre! grid generator will not generate graphs
      \item[Eirene] Only the \verb!eirobjx! executable will be built
      \item[B2.5] The graphical post-processors will not be built
      \item[Triang] The \verb!tria.eps! and \verb!triageom.eps! files will not be produced
...
\end{ve1rbatim}\index{setup\_baserun\_eirene\_links}
