...
\item[BCCON]\index{BCCON} \verb!integer array, length NS * NBC!, specifying
  ...
  \verb!CONPAR(,,1)! specifies the desired density in $m^{-3}$.
  \item[22] Feedback boundary condition: given total particle flux with constant average density. The poloidal density variation is added to make the solution as close as possible to the neoclassical value. It is recommended to use this boundary condition with corresponding boundary condition on ion temperature (\verb!BCENI=24!). The total desired flux is summed over all \verb!BCCON=22! core boundaries.
  \verb!CONPAR(,,1)! specifies the desired particle flux in $s^{-1}$.
  \item[23] Feedback boundary condition: given total particle flux with constant average density. The poloidal density variation is added to make the solution as close as possible to the neoclassical value. It is recommended to use this boundary condition with corresponding boundary condition on ion temperature (\verb!BCENI=24!). The total desired flux is summed over all \verb!BCCON=23! core boundaries.
  \verb!CONPAR(,,1)! specifies the desired particle flux in $s^{-1}$.
