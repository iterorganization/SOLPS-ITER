...
negative quantities on the same scale and ``M'' the absolute values of negative quantities in a separate plot)
  ...
  \item[fluxt \#1]\index{fluxt} Gives the recycling fluxes for the first \#1 \verb!Eirene! strata. The default value is all the strata, as read from the \verb!b2.neutrals.parameters! file, or if not present, the \$\verb!SOLPSTOP/src/B2.5/src/include.local/DIMENSIONS.F! file, or if not present, the \$\verb!SOLPSTOP/src/B2.5/src/include/DIMENSIONS.F! file.
...
\$\verb!SOLPSTOP/src/B2.5/src/include/DIMENSIONS.F!. If the dimensions are not right for you,
...
The file \$\verb!SOLPSTOP/src/B2.5/src/include/DIMENSIONS.F! and its local version
\$\verb!SOLPSTOP/src/B2.5/src/include.local/DIMENSIONS.F! contain key dimensions 
that determine
