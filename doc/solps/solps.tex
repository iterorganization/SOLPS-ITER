...
\label{sec:B2Eirene:averaging}\index{Averaging}
...
\begin{center}\index{b2plot, plasma quantities}
  \begin{longtable}{|l|l|}
    ...
    ni       & \index{b2plot, ni} Total density $(m^{-3})$ (\SOLPSfive runs) \\
