...
\begin{center}\index{b2plot, stack commands}
  \begin{longtable}{|c|c|c|c|c|c|c|c|l|}
    ...
    eirc \index{b2plot, eirc}        & 0 & 0 & 0 & 0 & 0 & 0 & \ref{sec:eirc}  & Copy {\tt Eirene} data onto {\tt B2.5} data \\
    ...
    m- \index{b2plot, m-}          & 0 & 0 & 0 & 2 & 0 & 0 & \ref{sec:m-}    & Matrix subtraction \\
    ...
    rmma, rmmax \index{b2plot, rmma}\index{b2plot, rmmax}        & 0 & 1 & 0 & 1 & 0 & 0 & \ref{sec:rmma}  & Maximum between real and matrix \\
    rmmi, rmmin \index{b2plot, rmmi}\index{b2plot, rmmin}         & 0 & 1 & 0 & 1 & 0 & 0 & \ref{sec:rmmi}  & Minimum between real and matrix \\
...
\begin{center}\index{b2plot, plot commands}
  \begin{longtable}{|c|c|c|c|c|c|c|c|l|}
    ...
    swid \index{b2plot, swid}        & 1 & 0 & 0 & 0 & 0 & 0 & \ref{sec:swid}   & Set {\tt WINID} \\
    t\_r+ \index{b2plot, t\_r+}      & 0 & 0 & 0 & 0 & 0 & 0 & \ref{sec:t_r+}   & Set ratio to {\tt .true.} \\
    t\_r- \index{b2plot, t\_r-}      & 0 & 0 & 0 & 0 & 0 & 0 & \ref{sec:t_r-}   & Set ratio to {\tt .false.} \\
...
\begin{center}\index{b2plot, character commands}
  \begin{longtable}{|c|c|c|c|c|c|c|c|l|}
    ...
    \hline \endfoot
    \endlastfoot
    adas \index{b2plot, adas}     & 0 & 0 & 1 & 0 & 0 & 0 & \ref{sec:adas}     & Access {\tt ADAS} data \\
    amju \index{b2plot, amju}, amjuel \index{b2plot, anjuel} & 0 & 0 & 4 & 0 & 0 & 0 & \ref{sec:amju} & Access {\tt AMJUEL} data \\
    ...
    cmdcdf \index{b2plot, cmdcdf}   & 0 & 0 & 1 & 0 & 0 & 0 & \ref{sec:cmdcdf}   & Loop command file on {\tt CDF} data \\
    ...
    flux \index{b2plot, flux}     & 0 & 0 & 1 & 0 & 0 & 0 & \ref{sec:flux}     & Call {\tt WOSlib} flux routine \\
    ...
    oson \index{b2plot, oson}     & 0 & 0 & 1 & 0 & 0 & 0 & \ref{sec:oson}     & Output geometry in {\tt Sonnet} format \\
    outp \index{b2plot, outp}     & 2 & 0 & 1 & 1 & 0 & 0 & \ref{sec:outp}     & Prints value of specific element \\
    pdev \index{b2plot, pdev}     & 0 & 0 & 1 & 0 & 0 & 0 & \ref{sec:pdev}     & {\tt PLPLOT} device name \\
    ...
    sonn \index{b2plot, sonn}     & 0 & 0 & 1 & 0 & 0 & 0 & \ref{sec:sonn}     & Read a new {\tt Sonnet} geometry \\
    ...
    uedgegrd \index{b2plot, uedgegrd} & 0 & 1 & 1 & 0 & 0 & 0 & \ref{sec:uedgegrd} & Output geometry in {\tt UEDGE} format \\
