...
\begin{center}\index{b2plot, plasma quantities}
  \begin{longtable}{|l|l|}
    ...
    fpsi     & \index{b2plot, fpsi} Normalised poloidal magnetic function $\psi$ \\
...
\begin{center}\index{b2plot, stack commands}
  \begin{longtable}{|c|c|c|c|c|c|c|c|c|l|}
    ...
    mpsi \index{b2plot, mpsi}      & 0 & 0 & 0 & 0 & 0 & 0 & 0 & \ref{sec:mpsi}  & Plot data against psi value \\
...
Use of the {\bf mmid} (see \ref{sec:mmid}) or {\bf mpsi} (see \ref{sec:mpsi})
commands allows for plotting versus the outer midplane (or another position
chosen by the user) radial coordinate, or against the normalized flux, respectively.
...
Toggles plotting 2-D radial plots against the normalised poloidal flux coordinate.
