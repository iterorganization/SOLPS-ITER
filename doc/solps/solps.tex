...
, where $\langle B^2 \rangle = \frac{\mathlarger{\iint \limits_{core}} B^2 \sqrt g dxdy}
...
here $\langle B^2 \rangle = \frac{\mathlarger{\oint} B^2 \sqrt{g} dx}{\mathlarger{\oint} \sqrt g dx}$
