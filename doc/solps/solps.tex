...
$\Gamma_{ex} = \sum \limits_{a=0}^{n_s-1} z_a \Gamma_{ax}^{(he)} - \frac{j^{\parallel}_x} e$,
...
\right) + \sum \limits^{n_s-1}_{a = 0} \frac{n_a T_i}{\sqrt{g}} \frac{\partial}{\partial x} \left(
...
$\Gamma_{iy} = \sum \limits_{a = 0}^{n_s -1} \Gamma_{ay}^{(he)}$
...
\frac{\partial}{h_x \partial x} 
\left( \frac{1}{B^2} \right)
\sum \limits^{n_s-1}_{\substack{a = 1, \\ z_a \neq 0}} m_a n_a \left\langle
	V^2_{a \parallel}
\right\rangle,
\end{equation*}
...
\frac{\sqrt g}{h_x} e \left[
	c_{ch,6} \sum \limits_{b=0}^{n_s-1} z_a \left(
		c_{n,a,7} |b_x| \sqrt{\frac{\sum \limits_{a=0}^{n_s-1} p_b}{\sum \limits_{b=0}^{n_s-1} m_b n_b}} n_a
	\right) + 
...
$\frac{\sqrt g}{h_x} j_x \Biggl|_W =
\frac{\sqrt g}{h_x} e \left[
	c_{ch,6} \sum \limits_{a=0}^{n_s-1} z_a \Gamma_{ax} +
...
$-\frac{\sqrt g}{h_x} j_x \Biggl|_E =
\frac{\sqrt g}{h_x} e \left[
	-\sum \limits_{a=0}^{n_s-1} z_a \Gamma_{ax} +
	\left( 1 - \gamma_e \right) |b_x| n_e \frac 1{\sqrt{2\pi}}
	\sqrt{\frac{T_e}{m_e}} exp \left( -\frac{e \left( \varphi - p_{\varphi,2}\right)}{T_e} \right)
\right] \Biggr|_E$, dpc
...
$-\frac{\sqrt g}{h_x} \widetilde q_{ex} \Bigl|_E = \left[
	...
	max\left(
		0,\frac{\sqrt g}{h_x} |b_x| n_e
		\sqrt{\frac{\sum \limits_{b=0}^{n_s-1} p_b}{\sum \limits_{a=0}^{n_s-1} m_b n_b}}
		-
		\frac{\sqrt g}{h_x} b_x \frac{j_{\parallel}}e
	\right) T_e
	+
...
q_{iy}^{P.Sch}
+
\frac{\sqrt g}{h_y} \frac 3 2 \sum \limits_{a=0}^{n_s-1} V_{ay}^{(E)} n_a T_i
+ \\
+\sum \limits_{a=0}^{n_s-1} max \left\{
	e_{rec,a} \left(
		\frac{3}{2} + B_{oRiS}
...
$u_{u_{out}} = p_{m,a_{main},1} c_s |b_x|$, $c_s = \sqrt{\frac{\sum \limits_{a=0}^{n_s-1} p_a}{\sum \limits_{a=0}^{n_s-1} m_a n_a}}$, $p_{m,a_{main},1} = 1.0$, \\\\ $p_{m,a_{main},1} = 1.0$
