...
\item[BCMOM]\index{BCMOM} {\tt integer array, length NS * NBC}, specifying
  ...
  \item[15] Prescribe the value of the parallel velocity as a function of poloidal coordinate
  \item[16] Prescribe the average value of the parallel velocity
  {\tt MOMPAR(,,1)} specifies the parallelv elocity in $m.s^{-1}$
...
\item[BCENE]\index{BCENE} {\tt integer array, length NBC}, specifying
  ...
  {\tt MOMPAR(,ISMAIN,2)} and the {\tt \allowbreak b2stbc\_sound\_model} switch]
  ...
  {\tt ENEPAR(,1)} specifies the leakage velocity in units of the electron thermal velocity.
  \end{description}
\item[BCENI]\index{BCENI} {\tt integer array, length NBC}, specifying the
  ...
  of {\tt MOMPAR(,ISMAIN,2)} and the {\tt \allowbreak b2stbc\_sound\_model} switch]
  ...
  {\tt ENIPAR(,1)} specifies the leakage velocity in units of the collective ion thermal velocity.
...
\item[CORR\_CORE\_DN]\index{CORR\_CORE\_DN} {\tt real array, length NS}, damping parameter for speed-up of the density equations in the core when drifts are activated
\item[CORR\_CORE\_DN]\index{CORR\_CORE\_DT} {\tt real}, damping parameter for speed-up of the temperature equations in the core when drifts are activated
...
\subsection{Energy balance equation for electrons}
...
\subsection{Energy balance equation for ions}
