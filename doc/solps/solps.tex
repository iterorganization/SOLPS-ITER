...
\left( \frac 4 3 \widetilde{\widetilde{\eta}}_{CLax} + \eta_{ANa} \right) \frac{\partial V_{\parallel a}}{h_x \partial x}, & z_a = 1~\&~z_{n,a} = 1 \\
m_a V_{\parallel a} \Gamma_{ax}^{Cor} -
\left( \frac 4 3 \widetilde{\widetilde{\eta}}_{CLax} + \eta_{ANa} \right) \frac{\partial V_{\parallel a}}{h_x \partial x}, & \mbox{otherwise} \\
\end{matrix}
\right.
\end{equation}
