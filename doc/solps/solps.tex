...
\begin{description}\index{Hostnames}
  ...
  \item[SPBSTU] St. Petersburg State PolyTechnical University: *.spbau.ru
...
\section{b2ye, error assessment}
\label{sec:b2ye}\index{b2ye}\index{error assessment}\index{b2time.nc}\index{b2favere}\index{b2run}

The program {\tt b2ye} is meant for computing error assessment of a coupled {\tt B2.5-Eirene} run where the averaging scheme described in Section \ref{sec:B2Eirene:averaging} above has been used. It is called by means of the command:
\begin{verbatim}
    b2run b2ye
\end{verbatim}
or
...
Sets label size to $\langle$factor$\rangle$ times default size (default = 1.0).
