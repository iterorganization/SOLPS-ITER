...
\begin{equation*}
\widetilde{f}_{ex} = \frac 3 2 \Gamma_{ex} + V_{ex}^{(str)} n_e - 0.71 \frac{j^{ \left( \parallel \right) }_x}e
\end{equation*}
...
q_{ex} =
\left[
	\frac 3 2 \Gamma_{ex} - 0.71 \frac{j^{\left( \parallel \right) }_x} e
	-
...
\left[
	...
	- 0.71 b_x \frac{\widetilde j_{\parallel}} e
\right] T_e -
\kappa_{ex} \frac 1{h_x} \frac{\partial T_e}{\partial x}
\end{equation*}
...
\left( \frac{4 \pi \varepsilon_0}{e^2}\right)^2$, where the Coulomb logarithm $\Lambda $ can
be chosen as
...
\left( z_{eff} \right) n_e \tau_e$ (Balescu formulation), with
$f_{k_e} \left( z_{eff} \right) = \frac{2.16 z_{eff}}{1 + 0.27 z_{eff}}$

$\kappa_{ex}^{(CL)} = \frac{T_e}{m_e} f_{k_e} \left( z_{eff} \right) n_e \tau_e$ (Zhadnov formulation), with
...
\begin{equation*}
\widetilde{\alpha}_{CLx} = c_{k^{(CL)_{ex}}}^{(Luciani)} \alpha_{CLx}
\end{equation*}
...
when {\tt 'b2sigp\_style'} is set to {\tt '2'} (Zhdanov formulation), and
$\alpha_{CLx} = b_x^2 \frac{e}{m_e} \sqrt{\frac 5 2} f_{\alpha} \left(z_{eff} \right) n_e \tau _e$ otherwise (Balescu formulation).
The parameter $\widetilde{c_e}^{(2)}$ is given by:
$\widetilde{c_e}^{(2)} = \frac{c_e^{(2)}}{\left( z_{eff} + \frac{\sqrt{2}}{2} \right)} = 1.56 \frac{(1 + 1.4 z_{eff})(1 + 0.52 z_{eff})}{(1 + 2.56 z_{eff})( 1 + 0.29 z_{eff})}\frac{1}{\left( z_{eff} + \frac{\sqrt{2}}{2} \right)}$, and
