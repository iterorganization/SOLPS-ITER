...
solps_openmp_mpi: carre divgeo b25eirene_openmp_mpi uinp_openmp_mpi triang amds_openmp_mpi sonnet-light manual
...
amds_openmp:
	cd modules/amds; ${MAKE} USE_OPENMP=-D_OPENMP SOLPS_OPENMP=yes

amds_openmp_mpi:
	cd modules/amds; ${MAKE} USE_MPI=-DUSE_MPI USE_OPENMP=-D_OPENMP SOLPS_MPI=yes SOLPS_OPENMP=yes
...
clean_solps_openmp_mpi: clean_carre clean_divgeo clean_b25eirene_openmp_mpi clean_uinp_openmp_mpi clean_triang clean_sonnet-light clean_manual clean_amds
...
clean_all_nox_openmp:   clean_carre_nox clean_divgeo_nox clean_b25_nox_openmp clean_eirene clean_b25eirene_nox_openmp clean_uinp_openmp clean_triang_nox clean_manual
