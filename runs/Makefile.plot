...
$(target_uf) : b2fgmtry b2fparam b2fstate b2fplasma
	...
	rm -f $(target_uf)
	cd b2uf.exe.dir ; ${TIME} ${B2OBJ}/b2uf.exe ${RUN_OPTIONS} ; mv $(target_uf) b2fplasmf .. ; rm -f $(notdir $^) .quit
	-rmdir b2uf.exe.dir

$(target_fu) : b2fgmtry b2fparam b2fstate b2fplasmf
	rm -rf b2fu.exe.dir >& /dev/null ; mkdir b2fu.exe.dir ; cp $^ b2fu.exe.dir
	rm -f $(target_fu)
	cd b2fu.exe.dir ; ${TIME} ${B2OBJ}/b2fu.exe ${RUN_OPTIONS} ; mv $(target_fu) b2fplasma .. ; rm -f $(notdir $^) .quit
	-rmdir b2fu.exe.dir
...
ifeq (${NCAR_VERSION},3)
	...
	cd b2pl.exe.dir ; ln -s ../HYDHEL ../METHANE ../SPUTER ../H2VIBR ../AMMONX ../fort.21 ../fort.22 ../graphite_ext.dat ../mo_ext.dat . ; ${TIME} ${B2OBJ}/b2pl.exe ${RUN_OPTIONS} ; mv -f gmeta .. ; rm -f $(target_pl) $(notdir $^) .quit param.dg
else
	rm -f $(target_pl) b2plot.ps
	cd b2pl.exe.dir ; ln -s ../HYDHEL ../METHANE ../SPUTER ../H2VIBR ../AMMONX ../fort.21 ../fort.22 ../graphite_ext.dat ../mo_ext.dat . ; ${TIME} ${B2OBJ}/b2pl.exe ${RUN_OPTIONS} ; mv -f b2plot.ps .. ; rm -f $(target_pl) $(notdir $^) .quit param.dg
endif
ifndef STAND_ALONE
	-rm b2pl.exe.dir/fort.44 b2pl.exe.dir/fort.46 b2pl.exe.dir/input.dat b2pl.exe.dir/fort.75
endif
	-cd b2pl.exe.dir ; rm -f HYDHEL METHANE SPUTER H2VIBR AMMONX fort.21 fort.22 graphite_ext.dat mo_ext.dat
	-rmdir b2pl.exe.dir
...
ifeq (${NCAR_VERSION},3)
	rm -f $(target_pl) gmeta
	cd b2pl.exe.dir ; ln -s ../HYDHEL ../METHANE ../SPUTER ../H2VIBR ../AMMONX ../fort.21 ../fort.22 ../graphite_ext.dat ../mo_ext.dat . ; ${DBX} ${INC} ${DBGOBJ}/b2pl.exe ${RUN_OPTIONS} ; mv -f gmeta .. ; rm -f $(target_pl) $(notdir $^) .quit param.dg
else
	rm -f $(target_pl) b2plot.ps
	cd b2pl.exe.dir ; ln -s ../HYDHEL ../METHANE ../SPUTER ../H2VIBR ../AMMONX ../fort.21 ../fort.22 ../graphite_ext.dat ../mo_ext.dat . ; ${DBX} ${INC} ${DBGOBJ}/b2pl.exe ${RUN_OPTIONS} ; mv -f b2plot.ps .. ; rm -f $(target_pl) $(notdir $^) .quit param.dg
endif
ifndef STAND_ALONE
	-rm b2pl.exe.dir/fort.44 b2pl.exe.dir/fort.46 b2pl.exe.dir/input.dat b2pl.exe.dir/fort.75
endif
...
ifndef STAND_ALONE
	...
	rm -f $(target_md)
	cd b2md.exe.dir ; ln -s ../HYDHEL ../METHANE ../SPUTER ../H2VIBR ../AMMONX ../fort.21 ../fort.22 ../graphite_ext.dat ../mo_ext.dat . ; ${SOLPSTOP}/scripts/mds_id | ${TIME} ${B2OBJ}/b2md.exe ${RUN_OPTIONS} ; mv $(target_md) .. ; mv shotnumber.history .. ; rm -f $(notdir $^) .quit ds*
ifndef STAND_ALONE
...
ifndef STAND_ALONE
	...
	rm -f $(target_md)
	cd b2md.exe.dir ; ln -s ../HYDHEL ../METHANE ../SPUTER ../H2VIBR ../AMMONX ../fort.21 ../fort.22 ../graphite_ext.dat ../mo_ext.dat . ; ${SOLPSTOP}/scripts/mds_id | ${DBX} ${INC} ${DBGOBJ}/b2md.exe ${RUN_OPTIONS} ; mv $(target_md) .. ; mv shotnumber.history .. ; rm -f $(notdir $^) .quit ds*
ifndef STAND_ALONE
	-rm b2md.exe.dir/fort.44 b2md.exe.dir/input.dat b2md.exe.dir/fort.75 >& /dev/null
endif
	-cd b2md.exe.dir ; rm -f HYDHEL METHANE SPUTER H2VIBR AMMONX fort.21 fort.22 graphite_ext.dat mo_ext.dat
...
$(target_rd) : shotnumber.history
	...
	rm -f $(target_rd)
	cd b2rd.exe.dir ; ${TIME} ${B2OBJ}/b2rd.exe ${RUN_OPTIONS} ; mv $(target_rd) .. ; rm -f $(notdir $^)
	-rmdir b2rd.exe.dir
...
$(target_yi) : b2yi.dat b2mn.dat b2fstate b2frates b2fgmtry
	...
	cd b2yi.exe.dir ; ${TIME} ${B2OBJ}/b2yi.exe ${RUN_OPTIONS} ; mv $(target_yi) .. ; rm -f $(notdir $^)
	-rmdir b2yi.exe.dir
...
$(target_yi_gnuplot) : b2mn.dat b2fstate b2frates b2fgmtry
	...
	cd b2yi_gnuplot.exe.dir ; ${TIME} ${B2OBJ}/b2yi_gnuplot.exe ${RUN_OPTIONS} ; mv $(target_yi_gnuplot) .. ; rm -f $(notdir $^)
...
$(target_yn) : b2yn.dat b2mn.dat b2ftrack b2frates b2fstate
	...
	cd b2yn.exe.dir ; ${TIME} ${B2OBJ}/b2yn.exe ${RUN_OPTIONS} ; mv $(target_yn) .. ; rm -f $(notdir $^)
	-rmdir b2yn.exe.dir
...
$(target_ymb) : b2ymb.dat wlld_trgi.dat wlld_trgo.dat wlly_trgi.dat wlly_trgo.dat
	...
	rm -f $(target_ymb)
	cd b2ymb.exe.dir ; ${TIME} ${B2OBJ}/b2ymb.exe ${RUN_OPTIONS} ; touch b2ymb.prt; mv $(target_ymb) .. ; rm -f $(notdir $^)
	-rmdir b2ymb.exe.dir
...
$(target_yrp) : b2yrp.dat wlld_irp.dat wlld_orp.dat wlly_irp.dat wlly_orp.dat
	...
	rm -f $(target_yrp)
	cd b2yrp.exe.dir ; ${TIME} ${B2OBJ}/b2yrp.exe ${RUN_OPTIONS} ; touch b2yrp.prt; mv $(target_yrp) .. ; rm -f $(notdir $^)
	-rmdir b2yrp.exe.dir

$(target_ydm) : b2ydm.dat wlld_dome.dat
	rm -rf b2ydm.exe.dir ; mkdir b2ydm.exe.dir ; cp $^ b2ydm.exe.dir
	rm -f $(target_ydm)
	cd b2ydm.exe.dir ; ${TIME} ${B2OBJ}/b2ydm.exe ${RUN_OPTIONS} ; touch b2ydm.prt; mv $(target_ydm) .. ; rm -f $(notdir $^)
	-rmdir b2ydm.exe.dir
